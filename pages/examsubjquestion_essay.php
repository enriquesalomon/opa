...
?> 
<?php include 'modal-add-exam-question_essay.php'?>
        ...
        <div class="row">
          ...
          <?php     
                ...
                if(!empty($_GET["examsubjectid"]) && !empty($_GET["examcategoryid"]) && !empty($_GET["classnameid"]) && !empty($_GET["eid"]) && !empty($_GET["sy"]) ){
                  ...
                  $check=mysqli_query($conn,"select * from examsubject_essay where id='" .$examsubjectid . "'");
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <?php
                include('dbconnect.php');                           
                $query=mysqli_query($conn," select *  from examquestion_essay where examsubjectid='".$examsubjectid."'");                                            
