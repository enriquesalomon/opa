        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./assignstudent.php" class="nav-link active">
                <i class="far fas-file nav-icon"></i>
                  <p>Assign Student</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Student Management</h1>
          </div>
          <div class="col-sm-6">
...
?> 
    <!-- Main content -->
    <?php include 'modal-add-assignstudent.php'?>
    <section class="content">
       <div class="container-fluid">
       <button class="btn btn-success"style="margin-bottom: 15px;"data-toggle="modal" data-target="#add"><i class="fa fa-plus" aria-hidden="true"></i></button>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                include('dbconnect.php');                           
                $query=mysqli_query($conn," select *  from studentclass");                                            
