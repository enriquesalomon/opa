    ...
    include 'dbconnect.php';
      ...
      $quizdatetime= mysqli_real_escape_string($conn, $_POST['quizdatetime']);
        ...
        if(!empty($_POST["quizdatetime"])) {
            $check=mysqli_query($conn,"select * from quizsubject_essay where quizid='" .$qid. "' AND  subjectid='" .$subjectnameid. "' AND  quizdatetime='" .$quizdatetime. "'");        
        ...
        $sql = "INSERT INTO quizsubject_essay VALUES (DEFAULT,'$qid','$subjectnameid','$quizdatetime','$totalquestion','$date','$timelimit')";   
